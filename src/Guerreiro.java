public class Guerreiro extends Personagem {
    ...
    public int mana;
    public String nome;
    public static String[] upgradesAtk = {"Mãos Calejadas", "Técnica de Espada", "Força Divina"};
    public static String[] upgradesDef = {"Treinamento Intenso", "Passos Rápidos", "Aura Divina"};
